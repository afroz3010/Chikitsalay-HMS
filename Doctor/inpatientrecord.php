                        ...
                        <?php  
                          ...
                          if ($result->num_rows > 0) {
                            ...
                            while($row = $result->fetch_assoc()){
                                  echo   "<tr><td>".$count."</td><td>".$row["PatientName"]."</td><td>".$row["PatientID"]."</td><td><button  type='submit' name='InPatientChart' value=".$row['PatientID']." class='btn btn-success align-self-center mx-auto'>Edit</button></td></tr>";
                                  $count++;
                                }
                            } else {
                                // echo "0 inpatients";
