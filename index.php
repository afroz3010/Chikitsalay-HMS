  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="Nurse/nurselogin.php"><span class="glyphicon glyphicon-log-in"></span> Nurses Login</a></li>
        ...
        <div id="div_login" class="text-center">
            ...
            <div>
             <div class="text-center">   
                <button  type="submit" name="ReceptionistLogin" value="Submit" class="btn btn-success align-self-center mx-auto">Log In</button>
             </div>   
            </div>
        </div>
    </form>
